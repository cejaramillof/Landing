...
class HelpsControllerTest < ActionController::TestCase
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post :create, help: { desc: @help.desc, email: @help.email, helped: @help.helped, ip: @help.ip, locale: @help.locale }
    end
  ...
  test "should update help" do
    patch :update, id: @help, help: { desc: @help.desc, email: @help.email, helped: @help.helped, ip: @help.ip, locale: @help.locale }
    assert_redirected_to help_path(assigns(:help))
  end
